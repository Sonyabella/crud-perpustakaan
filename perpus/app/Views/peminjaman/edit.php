...
<div class="card">
    ...
    <div class="form-group">
            ...
            <div class="form-group">
                <label for="Status_Peminjaman" style="color: #007bff">StatusPeminjaman</label>
                <input type="text" name="Status_Peminjaman" id="Status_Peminjaman" class="form-control" value="<?= $peminjaman['Status_Peminjaman'] ?>">
            </div>
